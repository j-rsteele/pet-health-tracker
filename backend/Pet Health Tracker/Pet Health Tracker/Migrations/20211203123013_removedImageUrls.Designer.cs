...
namespace Pet_Health_Tracker.Migrations
{
    ...
    [Migration("20211203123013_removedImageUrls")]
            ...
            modelBuilder.Entity("Pet_Health_Tracker.Models.Appointment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ApptDateTime = new DateTime(2021, 12, 3, 7, 30, 12, 850, DateTimeKind.Local).AddTicks(4329),
                        ...
                        {
                            Id = 2,
                            ApptDateTime = new DateTime(2021, 12, 3, 7, 30, 12, 850, DateTimeKind.Local).AddTicks(5201),
            ...
            modelBuilder.Entity("Pet_Health_Tracker.Models.MedicalItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ItemType = 0,
                            MedicalRecordId = 1,
                            TreatedOn = new DateTime(2021, 12, 3, 7, 30, 12, 848, DateTimeKind.Local).AddTicks(2821)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            ItemType = 1,
                            MedicalRecordId = 3,
                            TreatedOn = new DateTime(2021, 12, 3, 7, 30, 12, 850, DateTimeKind.Local).AddTicks(2031)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            ItemType = 2,
                            MedicalRecordId = 2,
                            TreatedOn = new DateTime(2021, 12, 3, 7, 30, 12, 850, DateTimeKind.Local).AddTicks(2060)
                        },
                        new
                        {
                            Id = 4,
                            ...
                            ItemType = 3,
                            MedicalRecordId = 1,
                            TreatedOn = new DateTime(2021, 12, 3, 7, 30, 12, 850, DateTimeKind.Local).AddTicks(2064)
                        },
                        new
                        {
                            Id = 5,
                            ...
                            ItemType = 4,
                            MedicalRecordId = 2,
                            TreatedOn = new DateTime(2021, 12, 3, 7, 30, 12, 850, DateTimeKind.Local).AddTicks(2067)
                        },
                        new
                        {
                            Id = 6,
                            ...
                            ItemType = 5,
                            MedicalRecordId = 3,
                            TreatedOn = new DateTime(2021, 12, 3, 7, 30, 12, 850, DateTimeKind.Local).AddTicks(2069)
                        });
                });
            ...
            modelBuilder.Entity("Pet_Health_Tracker.Models.Weight", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CurrentWeight = 50,
                            Date = new DateTime(2021, 12, 3, 7, 30, 12, 850, DateTimeKind.Local).AddTicks(3168),
                            PetId = 1
                        },
                        new
                        {
                            Id = 2,
                            CurrentWeight = 12,
                            Date = new DateTime(2021, 12, 3, 7, 30, 12, 850, DateTimeKind.Local).AddTicks(3537),
                            PetId = 2
                        },
                        new
                        {
                            Id = 3,
                            CurrentWeight = 2,
                            Date = new DateTime(2021, 12, 3, 7, 30, 12, 850, DateTimeKind.Local).AddTicks(3544),
                            PetId = 3
                        });
                });
